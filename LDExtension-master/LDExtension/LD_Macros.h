...
#define LD_mainWindow [UIApplication sharedApplication].delegate.window
...
#define LD_APPVERSION [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"]
...
//#define ConstHeight_StatusBar (IS_NotchScreen ? 44.0 : 20.0)
